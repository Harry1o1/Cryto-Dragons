...
export const Layout = () => {
        ...
        <div className="navbar-end bordered">
          <div className="dropdown">
            ...
            <div tabIndex={0} className="btn btn-square btn-ghost">
              <svg xmlns="http://www.w3.org/2000/svg" className="pnt-it h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  <div className="drop notifications-container">
    ...
    <Head>
        ...
        <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/Harry1o1/Crypto-Dragons/solana/Jrzy/style.css"/>
